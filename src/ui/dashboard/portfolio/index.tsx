                                                ...
                                                <div className='flex justify-between pt-2'>
                                                    <div className='flex gap-4'>
                                                        ...
                                                        <div className='relative top-1'>
                                                            <p className='text-primary font-semibold'>{item.symbol}</p>
                                                            <p className='text-[12px]'>{item.name}</p>
                                                        </div>
                                                    </div>
                                                    <div className='w-[5rem]'>
                                                        <p className='text-primary font-bold text-[10px]'>{profile?.currency} {item.price.toFixed(2)}</p>
                                                        <div className='flex'>
                                                            <p className={`font-normal ${getTextColor(item.movement)}`}>{item.percentageChange.toFixed(2)}%</p>
                    ...
                    <div>
                        <Card className='w-[100%] h-[100%] p-[2rem] dark:bg-[#151515] 2xl:w-[100%]'>
                            ...
                            <Table className='w-[100%]'>
                                ...
                                <TableBody>
                                    {portfolioStocks?.map((asset: any, index: any) => (
                                        <TableRow key={index}>
