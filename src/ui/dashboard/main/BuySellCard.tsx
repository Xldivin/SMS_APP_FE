...
const BuySellCard = ({ stocks, profile, token }: any) => {
    ...
    const confirmAction = async () => {
        ...
        try {
            if (quantity <= stockToBuy?.availableToBuy) {
                console.log("limit order");
                console.log(orderData);
                toast.success('Order placed successfully!');
            } else {
                toast.error('Error: Not enough stock available to buy.');
            }
        } catch (error) {
    ...
    const confirmActionToSell = async () => {
        ...
        try {
            if (quantity <= stockToBuy?.availableToSell) {
                console.log("limit order");
                console.log(orderData);
                toast.success('Order placed successfully!');
            } else {
                toast.error('Error: Not enough stock available to sell.');
            }
        } catch (error) {
            console.error('Error occurred:', error);
        } finally {
