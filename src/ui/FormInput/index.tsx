  ...
  return (
    <>
      <label className="block relative">
        <span className="block field-label text-textColor capitalize whitespace-nowrap">
          {label}
        </span>
        <input
          ...
          } text-[#000] font-poppins mt-1 px-3 py-2.5 bg-white border shadow-sm border-[#E2E1E1]  placeholder-slate-400 focus:outline-none focus:border-primary focus:ring-primary block w-full rounded-[14px] sm:text-sm focus:ring-1 `}
        />
