...
import Watchlist from '@/ui/dashboard/watchlist';
          ...
          <>
            <div className="lg:col-span-3 pt-[2rem]">
              <div className={`grid items-start gap-4 md:gap-6 2xl:flex 2xl:justify-center`}>
                <Watchlist isCollapsed={isCollapsed} watchlistStocks={watchlistStocks} stocks={stocks} token={token} profile={profile} />
              </div>
            </div>
          </>
        )}
